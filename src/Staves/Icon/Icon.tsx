...
const Image = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Mail = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Art = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Power = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Pen = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Video = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Note = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const People = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const User = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Problem = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Check = ({className, name}: IconProps) => (
  <svg
    width="100%"
    height="100%"
    viewBox="0 0 24 24"
...
const Twitter = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Pinterest = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Linkedin = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Behance = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Codepen = ({className, name}: IconProps) => (
  <svg
    height="30"
    width="30"
    viewBox="0 0 30 30"
...
const Github = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Medium = ({className, name}: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="100%"
    height="100%"
...
const Date = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Question = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Label = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Tools = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const LinkIcon = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Cookie = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
const Construction = ({className, name}: IconProps) => (
  <svg
    height="100%"
    width="100%"
    viewBox="0 0 24 24"
...
export const Icon = ({ name, className }: IconProps) => {
  switch (name) {
    case 'image':
      return <Image name={name} className={className}/>
    case 'mail':
      return <Mail name={name} className={className}/>
    case 'art':
      return <Art name={name} className={className}/>
    case 'power':
      return <Power name={name} className={className}/>
    case 'pen':
      return <Pen name={name} className={className}/>
    case 'video':
      return <Video name={name} className={className}/>
    case 'note':
      return <Note name={name} className={className}/>
    case 'people':
      return <People name={name} className={className}/>
    case 'user':
      return <User name={name} className={className}/>
    case 'problem':
      return <Problem name={name} className={className}/>
    case 'check':
      return <Check name={name} className={className}/>
    case 'twitter':
      return <Twitter name={name} className={className}/>
    case 'pinterest':
      return <Pinterest name={name} className={className}/>
    case 'linkedin':
      return <Linkedin name={name} className={className}/>
    case 'behance':
      return <Behance name={name} className={className}/>
    case 'codepen':
      return <Codepen name={name} className={className}/>
    case 'github':
      return <Github name={name} className={className}/>
    case 'medium':
      return <Medium name={name} className={className}/>
    case 'date':
      return <Date name={name} className={className}/>
    case 'question':
      return <Question name={name} className={className}/>
    case 'label':
      return <Label name={name} className={className}/>
    case 'tools':
      return <Tools name={name} className={className}/>
    case 'linkIcon':
      return <LinkIcon name={name} className={className}/>
    case 'cookie':
      return <Cookie name={name} className={className}/>
    case 'construction':
      return <Construction name={name} className={className}/>
    default:
      return null
  }
}
