...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-typescript",children:`import { registerIconLibrary } from '@orchestra-design-system/core'
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<orchestra-icon
  name="star"
...
`,e.jsx("div",{className:"stencil-props",children:e.jsx(a,{children:p})})]})}function w(r={}){const{wrapper:n}={...t(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(s,{...r})}):s(r)}export{w as default};
//# sourceMappingURL=icon-hBc1i5nM.js.map
