...
class OrchestraButton {
    ...
    onKeydown(event) {
        invariant(__classPrivateFieldGet(this, _OrchestraButton_button, "f"));
        if (event.key === 'Enter') {
            __classPrivateFieldGet(this, _OrchestraButton_button, "f").click();
        }
    }
    onKeyup(event) {
        invariant(__classPrivateFieldGet(this, _OrchestraButton_button, "f"));
    ...
    disabledChanged() {
        invariant(__classPrivateFieldGet(this, _OrchestraButton_button, "f"));
        if (this.disabled) {
            __classPrivateFieldGet(this, _OrchestraButton_button, "f").tabIndex = -1;
            __classPrivateFieldGet(this, _OrchestraButton_button, "f").ariaDisabled = this.disabled ? 'true' : null;
            __classPrivateFieldGet(this, _OrchestraButton_button, "f").disabled = this.disabled;
        }
    }
    componentDidLoad() {
        var _a;
        invariant(__classPrivateFieldGet(this, _OrchestraButton_button, "f"));
        __classPrivateFieldGet(this, _OrchestraButton_button, "f").type = (_a = this.type) !== null && _a !== void 0 ? _a : 'button';
