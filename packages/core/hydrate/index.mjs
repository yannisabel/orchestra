...
const buttonCss = () => `:host{--border-width:1px;--outline-width:1px;--outline-offset:2px;--outline-large-width:2px;display:inline-flex;border-radius:var(--orchestra-button-primary-container-radius)}.orchestra-button{display:flex;align-items:center;border-style:none;cursor:pointer}.orchestra-button[data-icon='only']{justify-content:center}.orchestra-button:disabled{cursor:not-allowed}.orchestra-button:focus-visible{box-shadow:0 0 0 var(--outline-large-width)     var(--orchestra-focus-outer-ring-color);outline:var(--outline-width) solid var(--orchestra-focus-inner-ring-color);outline-offset:0}.orchestra-button--primary{border:var(--orchestra-size-action-primary-border-width-default) solid     var(--orchestra-color-action-primary-border-default);background-color:var(--orchestra-color-action-primary-container-default);color:var(--orchestra-color-action-primary-content-default);border-radius:var(--orchestra-button-primary-container-radius);gap:var(--orchestra-button-primary-content-gap);padding-block-start:var(     --orchestra-button-primary-container-padding-block-start   );padding-block-end:var(     --orchestra-button-primary-container-padding-block-end   );padding-inline-start:var(     --orchestra-button-primary-container-padding-inline-start   );padding-inline-end:var(     --orchestra-button-primary-container-padding-inline-end   )}.orchestra-button--primary:hover{border:var(--orchestra-size-action-primary-border-width-hover) solid     var(--orchestra-color-action-primary-border-hover);background-color:var(--orchestra-color-action-primary-container-hover);color:var(--orchestra-color-action-primary-content-hover)}.orchestra-button--primary:active{border:var(--orchestra-size-action-primary-border-width-active) solid     var(--orchestra-color-action-primary-border-active);background-color:var(--orchestra-color-action-primary-container-active);color:var(--orchestra-color-action-primary-content-active)}.orchestra-button--primary:focus-visible{border:var(--orchestra-size-action-primary-border-width-focus) solid     var(--orchestra-color-action-primary-border-focus);background-color:var(--orchestra-color-action-primary-container-focus);color:var(--orchestra-color-action-primary-content-focus)}.orchestra-button--primary:disabled{border:var(--orchestra-size-action-primary-border-width-disabled) solid     var(--orchestra-color-action-primary-border-disabled);background-color:var(--orchestra-color-action-primary-container-disabled);color:var(--orchestra-color-action-primary-content-disabled)}.orchestra-button--secondary{border:var(--orchestra-size-action-secondary-border-width-default) solid     var(--orchestra-color-action-secondary-border-default);background-color:var(--orchestra-color-action-secondary-container-default);color:var(--orchestra-color-action-secondary-content-default);border-radius:var(--orchestra-button-secondary-container-radius);gap:var(--orchestra-button-secondary-content-gap);padding-block-start:var(     --orchestra-button-secondary-container-padding-block-start   );padding-block-end:var(     --orchestra-button-secondary-container-padding-block-end   );padding-inline-start:var(     --orchestra-button-secondary-container-padding-inline-start   );padding-inline-end:var(     --orchestra-button-secondary-container-padding-inline-end   )}.orchestra-button--secondary:hover{border:var(--orchestra-size-action-secondary-border-width-hover) solid     var(--orchestra-color-action-secondary-border-hover);background-color:var(--orchestra-color-action-secondary-container-hover);color:var(--orchestra-color-action-secondary-content-hover)}.orchestra-button--secondary:active{border:var(--orchestra-size-action-secondary-border-width-active) solid     var(--orchestra-color-action-secondary-border-active);background-color:var(--orchestra-color-action-secondary-container-active);color:var(--orchestra-color-action-secondary-content-active)}.orchestra-button--secondary:focus-visible{border:var(--orchestra-size-action-secondary-border-width-focus) solid     var(--orchestra-color-action-secondary-border-focus);background-color:var(--orchestra-color-action-secondary-container-focus);color:var(--orchestra-color-action-secondary-content-focus)}.orchestra-button--secondary:disabled{border:var(--orchestra-size-action-secondary-border-width-disabled) solid     var(--orchestra-color-action-secondary-border-disabled);background-color:var(--orchestra-color-action-secondary-container-disabled);color:var(--orchestra-color-action-secondary-content-disabled)}.orchestra-button--tertiary{border:var(--orchestra-size-action-tertiary-border-width-default) solid     var(--orchestra-color-action-tertiary-border-default);background-color:var(--orchestra-color-action-tertiary-container-default);color:var(--orchestra-color-action-tertiary-content-default);border-radius:var(--orchestra-button-tertiary-container-radius);gap:var(--orchestra-button-tertiary-content-gap);padding-block-start:var(     --orchestra-button-tertiary-container-padding-block-start   );padding-block-end:var(     --orchestra-button-tertiary-container-padding-block-end   );padding-inline-start:var(     --orchestra-button-tertiary-container-padding-inline-start   );padding-inline-end:var(     --orchestra-button-tertiary-container-padding-inline-end   )}.orchestra-button--tertiary:hover{border:var(--orchestra-size-action-tertiary-border-width-hover) solid     var(--orchestra-color-action-tertiary-border-hover);background-color:var(--orchestra-color-action-tertiary-container-hover);color:var(--orchestra-color-action-tertiary-content-hover)}.orchestra-button--tertiary:active{border:var(--orchestra-size-action-tertiary-border-width-active) solid     var(--orchestra-color-action-tertiary-border-active);background-color:var(--orchestra-color-action-tertiary-container-active);color:var(--orchestra-color-action-tertiary-content-active)}.orchestra-button--tertiary:focus-visible{border:var(--orchestra-size-action-tertiary-border-width-focus) solid     var(--orchestra-color-action-tertiary-border-focus);background-color:var(--orchestra-color-action-tertiary-container-focus);color:var(--orchestra-color-action-tertiary-content-focus)}.orchestra-button--tertiary:disabled{border:var(--orchestra-size-action-tertiary-border-width-disabled) solid     var(--orchestra-color-action-tertiary-border-disabled);background-color:var(--orchestra-color-action-tertiary-container-disabled);color:var(--orchestra-color-action-tertiary-content-disabled)}.orchestra-button--primary.orchestra-button--small{padding:var(--orchestra-button-primary-container-padding);font-size:var(--orchestra-size-action-common-content-small);line-height:var(--orchestra-size-action-common-content-small)}.orchestra-button--primary.orchestra-button--small orchestra-icon{--icon-size:var(--orchestra-size-action-common-content-small)}.orchestra-button--secondary.orchestra-button--small{padding:var(--orchestra-button-secondary-container-padding);font-size:var(--orchestra-size-action-common-content-small);line-height:var(--orchestra-size-action-common-content-small)}.orchestra-button--secondary.orchestra-button--small orchestra-icon{--icon-size:var(--orchestra-size-action-common-content-small)}.orchestra-button--tertiary.orchestra-button--small{padding:var(--orchestra-button-tertiary-container-padding);font-size:var(--orchestra-size-action-common-content-small);line-height:var(--orchestra-size-action-common-content-small)}.orchestra-button--tertiary.orchestra-button--small orchestra-icon{--icon-size:var(--orchestra-size-action-common-content-small)}.orchestra-button--primary.orchestra-button--medium{font-size:var(--orchestra-size-action-common-content-medium);line-height:var(--orchestra-size-action-common-content-medium)}.orchestra-button--primary.orchestra-button--medium orchestra-icon{--icon-size:var(--orchestra-size-action-common-content-medium)}.orchestra-button--secondary.orchestra-button--medium{font-size:var(--orchestra-size-action-common-content-medium);line-height:var(--orchestra-size-action-common-content-medium)}.orchestra-button--secondary.orchestra-button--medium orchestra-icon{--icon-size:var(--orchestra-size-action-common-content-medium)}.orchestra-button--tertiary.orchestra-button--medium{font-size:var(--orchestra-size-action-common-content-medium);line-height:var(--orchestra-size-action-common-content-medium)}.orchestra-button--tertiary.orchestra-button--medium orchestra-icon{--icon-size:var(--orchestra-size-action-common-content-medium)}.orchestra-button--primary.orchestra-button--large{font-size:var(--orchestra-size-action-common-content-large);line-height:var(--orchestra-size-action-common-content-large)}.orchestra-button--primary.orchestra-button--large orchestra-icon{--icon-size:var(--orchestra-size-action-common-content-large)}.orchestra-button--secondary.orchestra-button--large{font-size:var(--orchestra-size-action-common-content-large);line-height:var(--orchestra-size-action-common-content-large)}.orchestra-button--secondary.orchestra-button--large orchestra-icon{--icon-size:var(--orchestra-size-action-common-content-large)}.orchestra-button--tertiary.orchestra-button--large{font-size:var(--orchestra-size-action-common-content-large);line-height:var(--orchestra-size-action-common-content-large)}.orchestra-button--tertiary.orchestra-button--large orchestra-icon{--icon-size:var(--orchestra-size-action-common-content-large)}.orchestra-button--small.orchestra-button[data-icon='only']{height:var(--orchestra-size-action-common-container-small);width:var(--orchestra-size-action-common-container-small)}.orchestra-button--medium.orchestra-button[data-icon='only']{height:var(--orchestra-size-action-common-container-medium);width:var(--orchestra-size-action-common-container-medium)}.orchestra-button--large.orchestra-button[data-icon='only']{height:var(--orchestra-size-action-common-container-large);width:var(--orchestra-size-action-common-container-large)}.orchestra-overflow{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}`;
...
var _OrchestraButton_button, _OrchestraButton_buttonRef, _OrchestraButton_onClick, _OrchestraButton_hasTextDisplayed, _OrchestraButton_getAriaLabel;
const preventDefault = (event) => {
    event.preventDefault();
};
class OrchestraButton {
    constructor(hostRef) {
        ...
        _OrchestraButton_buttonRef.set(this, (button) => {
            __classPrivateFieldSet$1(this, _OrchestraButton_button, button, "f");
        });
        _OrchestraButton_onClick.set(this, (event) => {
            if (this.disabled) {
                preventDefault(event);
                event.stopImmediatePropagation();
            }
        });
        _OrchestraButton_hasTextDisplayed.set(this, () => {
            return this.icon === 'start' || this.icon === 'end' || this.icon === 'none';
        });
        _OrchestraButton_getAriaLabel.set(this, () => {
            if (this.icon === 'only') {
                return this.text;
            }
            return undefined;
    ...
    onKeydown(event) {
        invariant(__classPrivateFieldGet$1(this, _OrchestraButton_button, "f"));
        if (event.key === 'Enter') {
            __classPrivateFieldGet$1(this, _OrchestraButton_button, "f").click();
        }
    }
    onKeyup(event) {
        invariant(__classPrivateFieldGet$1(this, _OrchestraButton_button, "f"));
    ...
    disabledChanged() {
        invariant(__classPrivateFieldGet$1(this, _OrchestraButton_button, "f"));
        if (this.disabled) {
            __classPrivateFieldGet$1(this, _OrchestraButton_button, "f").tabIndex = -1;
            __classPrivateFieldGet$1(this, _OrchestraButton_button, "f").ariaDisabled = this.disabled ? 'true' : null;
            __classPrivateFieldGet$1(this, _OrchestraButton_button, "f").disabled = this.disabled;
        }
    }
    componentDidLoad() {
        var _a;
        invariant(__classPrivateFieldGet$1(this, _OrchestraButton_button, "f"));
        __classPrivateFieldGet$1(this, _OrchestraButton_button, "f").type = (_a = this.type) !== null && _a !== void 0 ? _a : 'button';
        this.disabledChanged();
    }
    render() {
        return (hAsync(Host, { key: 'a897b1a8881e190e84c1b6c106ea6e7ac6599fd2' }, hAsync("button", { key: 'b63d77364f5399e3c402c314ed64fcccb54c5833', class: `orchestra-button orchestra-button--${this.variant} orchestra-button--${this.size}`, type: this.type, ref: __classPrivateFieldGet$1(this, _OrchestraButton_buttonRef, "f"), disabled: this.disabled, "aria-label": __classPrivateFieldGet$1(this, _OrchestraButton_getAriaLabel, "f").call(this), "data-icon": this.icon, onClick: __classPrivateFieldGet$1(this, _OrchestraButton_onClick, "f") }, this.iconName && (this.icon === 'start' || this.icon === 'only') && (hAsync("orchestra-icon", { key: '28e1b3e3a40a4d27987599211399df0a7decf943', name: this.iconName, library: this.iconLibrary })), __classPrivateFieldGet$1(this, _OrchestraButton_hasTextDisplayed, "f").call(this) && (hAsync("span", { key: '41ff655266057daae9c6c7b65e88691e417b4f71', class: "orchestra-overflow" }, this.text)), this.iconName && this.icon === 'end' && (hAsync("orchestra-icon", { key: 'c2106d0ee7873161c8dbc4babf9ea1086c54e3c7', name: this.iconName, library: this.iconLibrary })))));
    }
...
_OrchestraButton_button = new WeakMap(), _OrchestraButton_buttonRef = new WeakMap(), _OrchestraButton_onClick = new WeakMap(), _OrchestraButton_hasTextDisplayed = new WeakMap(), _OrchestraButton_getAriaLabel = new WeakMap();

const checkboxCss = () => `:host{--checkbox-size:var(--orchestra-size-action-common-content-small, 1rem);--checkbox-hit-area-padding:var(     --orchestra-spacing-action-primary-small,     0.25rem   );display:inline-flex;flex-direction:column;align-items:flex-start;gap:var(--orchestra-spacing-action-primary-small, 0.25rem)}.orchestra-checkbox-row{display:inline-flex;align-items:center;gap:var(--orchestra-spacing-action-primary-small, 0.25rem)}.orchestra-checkbox-box{position:relative;width:var(--checkbox-size);height:var(--checkbox-size);padding:var(--checkbox-hit-area-padding);flex-shrink:0}.orchestra-checkbox{appearance:none;box-sizing:border-box;position:absolute;inset:var(--checkbox-hit-area-padding);width:var(--checkbox-size);height:var(--checkbox-size);padding:0;margin:0;border-style:solid;cursor:pointer;flex-shrink:0;display:flex;align-items:center;justify-content:center;border-radius:var(--orchestra-radius-action-primary-small, 0.25rem);border-width:var(--orchestra-size-action-primary-border-width-default, 2px);border-color:var(--orchestra-color-action-toggle-off-border-default);background-color:var(--orchestra-color-action-toggle-off-container-default);font-size:0;transition:all 150ms ease-in-out}@media (prefers-reduced-motion: reduce){.orchestra-checkbox{transition:none}}.orchestra-checkbox-visual{position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);width:var(--checkbox-size);height:var(--checkbox-size);pointer-events:none;display:flex;align-items:center;justify-content:center;z-index:1}.orchestra-checkbox-icon{display:block;width:0.625rem;height:0.625rem;pointer-events:none}.orchestra-checkbox-label{cursor:pointer;font-family:var(--orchestra-font-family-default);font-size:var(--orchestra-font-size-body-default, 1rem);line-height:1.5;color:var(--orchestra-color-text-primary);user-select:none;-webkit-user-select:none}.orchestra-checkbox:disabled~.orchestra-checkbox-label{cursor:not-allowed;color:var(--orchestra-color-text-disabled)}.orchestra-checkbox:disabled{cursor:not-allowed}.orchestra-checkbox:focus-visible{box-shadow:0 0 0 4px var(--orchestra-focus-outer-ring-color);outline:2px solid var(--orchestra-focus-inner-ring-color);outline-offset:0}.orchestra-checkbox:hover:not(:disabled){border-color:var(--orchestra-color-action-toggle-off-border-hover);background-color:var(--orchestra-color-action-toggle-off-container-hover)}.orchestra-checkbox:active:not(:disabled){border-color:var(--orchestra-color-action-toggle-off-border-active);background-color:var(--orchestra-color-action-toggle-off-container-active)}.orchestra-checkbox:focus-visible{border-color:var(--orchestra-color-action-toggle-off-border-focus);background-color:var(--orchestra-color-action-toggle-off-container-focus)}.orchestra-checkbox:disabled{border-color:var(--orchestra-color-action-toggle-off-border-disabled);background-color:var(--orchestra-color-action-toggle-off-container-disabled)}:host([data-invalid='true']) .orchestra-checkbox:not(:disabled){border-color:var(--orchestra-color-action-toggle-off-border-highlight)}.orchestra-checkbox:checked{border-color:var(--orchestra-color-action-toggle-on-border-default);background-color:var(--orchestra-color-action-toggle-on-container-default)}.orchestra-checkbox:checked:hover:not(:disabled){border-color:var(--orchestra-color-action-toggle-on-border-hover);background-color:var(--orchestra-color-action-toggle-on-container-hover)}.orchestra-checkbox:checked:active:not(:disabled){border-color:var(--orchestra-color-action-toggle-on-border-active);background-color:var(--orchestra-color-action-toggle-on-container-active)}.orchestra-checkbox:checked:focus-visible{border-color:var(--orchestra-color-action-toggle-on-border-focus);background-color:var(--orchestra-color-action-toggle-on-container-focus)}.orchestra-checkbox:checked:disabled{border-color:var(--orchestra-color-action-toggle-on-border-disabled);background-color:var(--orchestra-color-action-toggle-on-container-disabled)}:host([data-invalid='true']) .orchestra-checkbox:checked:not(:disabled),:host([data-invalid='true'][data-indeterminate='true']) .orchestra-checkbox:not(:disabled){border-color:var(--orchestra-color-action-toggle-on-border-highlight)}.orchestra-checkbox:indeterminate{border-color:var(--orchestra-color-action-toggle-on-border-default);background-color:var(--orchestra-color-action-toggle-on-container-default)}.orchestra-checkbox:indeterminate:hover:not(:disabled){border-color:var(--orchestra-color-action-toggle-on-border-hover);background-color:var(--orchestra-color-action-toggle-on-container-hover)}.orchestra-checkbox:indeterminate:active:not(:disabled){border-color:var(--orchestra-color-action-toggle-on-border-active);background-color:var(--orchestra-color-action-toggle-on-container-active)}.orchestra-checkbox:indeterminate:focus-visible{border-color:var(--orchestra-color-action-toggle-on-border-focus);background-color:var(--orchestra-color-action-toggle-on-container-focus)}.orchestra-checkbox:indeterminate:disabled{border-color:var(--orchestra-color-action-toggle-on-border-disabled);background-color:var(--orchestra-color-action-toggle-on-container-disabled)}:host[data-indeterminate='true'] .orchestra-checkbox{border-color:var(--orchestra-color-action-toggle-on-border-default);background-color:var(--orchestra-color-action-toggle-on-container-default)}:host[data-indeterminate='true'] .orchestra-checkbox:hover:not(:disabled){border-color:var(--orchestra-color-action-toggle-on-border-hover);background-color:var(--orchestra-color-action-toggle-on-container-hover)}:host[data-indeterminate='true'] .orchestra-checkbox:active:not(:disabled){border-color:var(--orchestra-color-action-toggle-on-border-active);background-color:var(--orchestra-color-action-toggle-on-container-active)}:host[data-indeterminate='true'] .orchestra-checkbox:focus-visible{border-color:var(--orchestra-color-action-toggle-on-border-focus);background-color:var(--orchestra-color-action-toggle-on-container-focus)}:host[data-indeterminate='true'] .orchestra-checkbox:disabled{border-color:var(--orchestra-color-action-toggle-on-border-disabled);background-color:var(--orchestra-color-action-toggle-on-container-disabled)}.orchestra-checkbox:checked~.orchestra-checkbox-visual,.orchestra-checkbox:indeterminate~.orchestra-checkbox-visual,:host[data-indeterminate='true'] .orchestra-checkbox~.orchestra-checkbox-visual{color:var(--orchestra-color-action-toggle-on-content-default)}.orchestra-checkbox:checked:hover:not(:disabled)~.orchestra-checkbox-visual,.orchestra-checkbox:indeterminate:hover:not(:disabled)~.orchestra-checkbox-visual,:host[data-indeterminate='true'] .orchestra-checkbox:hover:not(:disabled)~.orchestra-checkbox-visual{color:var(--orchestra-color-action-toggle-on-content-hover)}.orchestra-checkbox:checked:active:not(:disabled)~.orchestra-checkbox-visual,.orchestra-checkbox:indeterminate:active:not(:disabled)~.orchestra-checkbox-visual,:host[data-indeterminate='true'] .orchestra-checkbox:active:not(:disabled)~.orchestra-checkbox-visual{color:var(--orchestra-color-action-toggle-on-content-active)}.orchestra-checkbox:checked:focus-visible~.orchestra-checkbox-visual,.orchestra-checkbox:indeterminate:focus-visible~.orchestra-checkbox-visual,:host[data-indeterminate='true'] .orchestra-checkbox:focus-visible~.orchestra-checkbox-visual{color:var(--orchestra-color-action-toggle-on-content-focus)}.orchestra-checkbox:checked:disabled~.orchestra-checkbox-visual,.orchestra-checkbox:indeterminate:disabled~.orchestra-checkbox-visual,:host[data-indeterminate='true'] .orchestra-checkbox:disabled~.orchestra-checkbox-visual{color:var(--orchestra-color-action-toggle-on-content-disabled)}@media (forced-colors: active){.orchestra-checkbox{forced-color-adjust:auto;border-color:CanvasText;background-color:Canvas}.orchestra-checkbox:checked,.orchestra-checkbox:indeterminate,:host[data-indeterminate='true'] .orchestra-checkbox{background-color:Highlight;border-color:Highlight}.orchestra-checkbox:checked~.orchestra-checkbox-visual,.orchestra-checkbox:indeterminate~.orchestra-checkbox-visual,:host[data-indeterminate='true'] .orchestra-checkbox~.orchestra-checkbox-visual{color:HighlightText}.orchestra-checkbox:focus-visible{box-shadow:none;outline:2px solid Highlight;outline-offset:2px}}.orchestra-checkbox-error-container{display:block;width:100%;margin-top:-0.125rem}.orchestra-checkbox-error-container::slotted(*){display:block;color:var(--orchestra-color-action-error-text-default);font-size:var(--orchestra-font-size-utility-small, 0.75rem);font-family:var(--orchestra-font-family-default);line-height:1.5}`;
...
var _OrchestraCheckbox_checkbox, _OrchestraCheckbox_hasWarnedMissingAccessibleName, _OrchestraCheckbox_defaultChecked, _OrchestraCheckbox_defaultIndeterminate, _OrchestraCheckbox_checkboxRef;
class OrchestraCheckbox {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.orchestraChange = createEvent(this, "orchestraChange");
        this.orchestraStateChange = createEvent(this, "orchestraStateChange");
        ...
        _OrchestraCheckbox_checkbox.set(this, void 0);
        _OrchestraCheckbox_hasWarnedMissingAccessibleName.set(this, false);
        _OrchestraCheckbox_defaultChecked.set(this, false);
        _OrchestraCheckbox_defaultIndeterminate.set(this, false);
        this.invalid = false;
        /**
        ...
        this.handleChange = (e) => {
            ...
            const wasIndeterminate = (_a = this.indeterminate) !== null && _a !== void 0 ? _a : false;
            ...
            this.orchestraChange.emit((_b = this.checked) !== null && _b !== void 0 ? _b : false);
            this.orchestraStateChange.emit({
                checked: (_c = this.checked) !== null && _c !== void 0 ? _c : false,
                indeterminate: (_d = this.indeterminate) !== null && _d !== void 0 ? _d : false,
                name: (_e = this.name) !== null && _e !== void 0 ? _e : '',
                value: (_f = this.value) !== null && _f !== void 0 ? _f : 'on',
            });
        };
        this.handleLabelClick = (e) => {
            var _a, _b;
            e.preventDefault();
            if (!((_a = this.disabled) !== null && _a !== void 0 ? _a : false)) {
                this.checked = !((_b = this.checked) !== null && _b !== void 0 ? _b : false);
            }
        };
        _OrchestraCheckbox_checkboxRef.set(this, (checkbox) => {
            __classPrivateFieldSet(this, _OrchestraCheckbox_checkbox, checkbox, "f");
        });
    }
    /**
    ...
    checkedChanged() {
        ...
        __classPrivateFieldGet(this, _OrchestraCheckbox_checkbox, "f").checked = (_a = this.checked) !== null && _a !== void 0 ? _a : false;
        this.syncFormValue();
        this.syncValidity();
    }
    ...
    disabledChanged() {
        var _a;
        invariant(__classPrivateFieldGet(this, _OrchestraCheckbox_checkbox, "f"));
        __classPrivateFieldGet(this, _OrchestraCheckbox_checkbox, "f").disabled = (_a = this.disabled) !== null && _a !== void 0 ? _a : false;
        this.syncValidity();
    }
    requiredChanged() {
        var _a;
        invariant(__classPrivateFieldGet(this, _OrchestraCheckbox_checkbox, "f"));
        __classPrivateFieldGet(this, _OrchestraCheckbox_checkbox, "f").required = (_a = this.required) !== null && _a !== void 0 ? _a : false;
        this.syncValidity();
    }
    valueChanged() {
        var _a;
        invariant(__classPrivateFieldGet(this, _OrchestraCheckbox_checkbox, "f"));
        __classPrivateFieldGet(this, _OrchestraCheckbox_checkbox, "f").value = (_a = this.value) !== null && _a !== void 0 ? _a : 'on';
        this.syncFormValue();
    }
    nameChanged() {
        var _a;
        invariant(__classPrivateFieldGet(this, _OrchestraCheckbox_checkbox, "f"));
        __classPrivateFieldGet(this, _OrchestraCheckbox_checkbox, "f").name = (_a = this.name) !== null && _a !== void 0 ? _a : '';
    }
    ...
    componentDidLoad() {
        var _a, _b;
        invariant(__classPrivateFieldGet(this, _OrchestraCheckbox_checkbox, "f"));
        __classPrivateFieldGet(this, _OrchestraCheckbox_checkbox, "f").type = 'checkbox';
        __classPrivateFieldSet(this, _OrchestraCheckbox_defaultChecked, (_a = this.checked) !== null && _a !== void 0 ? _a : false, "f");
        __classPrivateFieldSet(this, _OrchestraCheckbox_defaultIndeterminate, (_b = this.indeterminate) !== null && _b !== void 0 ? _b : false, "f");
        this.nameChanged();
        this.valueChanged();
        this.disabledChanged();
    ...
    formResetCallback() {
        this.checked = __classPrivateFieldGet(this, _OrchestraCheckbox_defaultChecked, "f");
        this.indeterminate = __classPrivateFieldGet(this, _OrchestraCheckbox_defaultIndeterminate, "f");
    }
    ...
    warnIfMissingAccessibleName() {
        if (__classPrivateFieldGet(this, _OrchestraCheckbox_hasWarnedMissingAccessibleName, "f")) {
            return;
        }
        if (this.hasAccessibleName()) {
            return;
        }
        console.warn('[orchestra-checkbox] Missing accessible name. Provide a linked <label>, aria-label, or aria-labelledby.', this.host);
        __classPrivateFieldSet(this, _OrchestraCheckbox_hasWarnedMissingAccessibleName, true, "f");
    }
    hasAccessibleName() {
        var _a, _b, _c;
        if (((_a = this.ariaLabel) === null || _a === void 0 ? void 0 : _a.trim()) || ((_b = this.ariaLabelledby) === null || _b === void 0 ? void 0 : _b.trim())) {
            return true;
        }
        if (this.host.closest('label')) {
            return true;
        }
        const id = (_c = this.htmlId) === null || _c === void 0 ? void 0 : _c.trim();
        if (!id) {
            return false;
        }
    ...
    syncFormValue() {
        var _a, _b, _c, _d, _e;
        const shouldSubmitValue = ((_a = this.checked) !== null && _a !== void 0 ? _a : false) && !((_b = this.disabled) !== null && _b !== void 0 ? _b : false);
        const submitValue = shouldSubmitValue ? ((_c = this.value) !== null && _c !== void 0 ? _c : 'on') : null;
        const state = JSON.stringify({
            checked: (_d = this.checked) !== null && _d !== void 0 ? _d : false,
            indeterminate: (_e = this.indeterminate) !== null && _e !== void 0 ? _e : false,
        });
        this.internals.setFormValue(submitValue, state);
    }
    syncValidity() {
        var _a, _b, _c, _d, _e;
        const customMessage = (_b = (_a = this.validationMessage) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : '';
        const isRequiredMissing = ((_c = this.required) !== null && _c !== void 0 ? _c : false) &&
            !((_d = this.checked) !== null && _d !== void 0 ? _d : false) &&
            !((_e = this.disabled) !== null && _e !== void 0 ? _e : false);
        if (customMessage) {
            this.internals.setValidity({ customError: true }, customMessage, __classPrivateFieldGet(this, _OrchestraCheckbox_checkbox, "f"));
            this.invalid = true;
            return;
        }
        if (isRequiredMissing) {
            this.internals.setValidity({ valueMissing: true }, 'Please check this box if you want to proceed.', __classPrivateFieldGet(this, _OrchestraCheckbox_checkbox, "f"));
            this.invalid = true;
            return;
        }
    ...
    render() {
        var _a, _b;
        const showIndicator = ((_a = this.checked) !== null && _a !== void 0 ? _a : false) || ((_b = this.indeterminate) !== null && _b !== void 0 ? _b : false);
        const indicatorName = this.indeterminate
            ? 'checkbox-indeterminate'
            : 'checkbox-check';
        return (hAsync(Host, { key: 'ccc1fe411dfe977346876a87249aa8492917de20', "data-indeterminate": this.indeterminate, "data-invalid": this.invalid }, hAsync("input", { key: '06161d728d1bc487da8c7e45d66bece5249f8510', id: this.htmlId, class: "orchestra-checkbox", type: "checkbox", "aria-label": this.ariaLabel, "aria-labelledby": this.ariaLabelledby, "aria-describedby": this.ariaDescribedby, "aria-invalid": this.invalid ? 'true' : undefined, ref: __classPrivateFieldGet(this, _OrchestraCheckbox_checkboxRef, "f"), onChange: this.handleChange }), hAsync("span", { key: '106b6ff2ca8502eece26b5525708d9aace94a82d', class: "orchestra-checkbox-visual" }, showIndicator && (hAsync("orchestra-icon", { key: '3175bc81b3a034da13dd8596145a85d462694a99', class: "orchestra-checkbox-icon", name: indicatorName, library: "orchestra-icons", fill: "currentcolor", size: "0.625rem" })))));
    }
    static get delegatesFocus() { return true; }
    static get formAssociated() { return true; }
    get host() { return getElement(this); }
    ...
    static get cmpMeta() { return {
        ...
        "$listeners$": undefined,
        "$lazyBundleId$": "-",
        "$attrsToReflect$": [["checked", "checked"], ["indeterminate", "indeterminate"], ["disabled", "disabled"]]
    }; }
}
_OrchestraCheckbox_checkbox = new WeakMap(), _OrchestraCheckbox_hasWarnedMissingAccessibleName = new WeakMap(), _OrchestraCheckbox_defaultChecked = new WeakMap(), _OrchestraCheckbox_defaultIndeterminate = new WeakMap(), _OrchestraCheckbox_checkboxRef = new WeakMap();
...
const checkboxCheck = `<svg viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M7.67037 0.202443C7.29674 -0.120944 6.7564 -0.0492173 6.46289 0.362728L2.77679 5.54032L1.50655 3.85832C1.19862 3.4722 0.668154 3.42682 0.309981 3.75594C-0.0481913 4.08507 -0.103896 4.66909 0.184328 5.07332L2.13585 7.65865C2.15377 7.6824 2.17977 7.69031 2.1986 7.71208C2.21906 7.74195 2.24122 7.77037 2.26493 7.79717C2.30312 7.82453 2.3433 7.84836 2.38505 7.86841C2.41393 7.8882 2.44386 7.90605 2.47469 7.92184C2.5761 7.9705 2.68507 7.99704 2.79561 8H2.79651C2.9116 7.99732 3.02502 7.96906 3.12998 7.91689C3.16185 7.89961 3.19269 7.88011 3.22231 7.85851C3.26618 7.83628 3.30818 7.80979 3.34781 7.77936C3.37103 7.75124 3.39259 7.72149 3.41235 7.69031C3.43028 7.67053 3.45628 7.66063 3.47331 7.63689L7.81649 1.53617C8.10989 1.12336 8.04446 0.526173 7.67037 0.202444V0.202443Z" fill="currentColor"/>
</svg>
`;
const checkboxIndeterminate = `<svg viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
  <rect x="1" y="3.25" width="6" height="1.5" rx="0.75" fill="currentColor"/>
</svg>
`;
const checked = `<svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M7.67037 0.202443C7.29674 -0.120944 6.7564 -0.0492173 6.46289 0.362728L2.77679 5.54032L1.50655 3.85832C1.19862 3.4722 0.668154 3.42682 0.309981 3.75594C-0.0481913 4.08507 -0.103896 4.66909 0.184328 5.07332L2.13585 7.65865C2.15377 7.6824 2.17977 7.69031 2.1986 7.71208C2.21906 7.74195 2.24122 7.77037 2.26493 7.79717C2.30312 7.82453 2.3433 7.84836 2.38505 7.86841C2.41393 7.8882 2.44386 7.90605 2.47469 7.92184C2.5761 7.9705 2.68507 7.99704 2.79561 8H2.79651C2.9116 7.99732 3.02502 7.96906 3.12998 7.91689C3.16185 7.89961 3.19269 7.88011 3.22231 7.85851C3.26618 7.83628 3.30818 7.80979 3.34781 7.77936C3.37103 7.75124 3.39259 7.72149 3.41235 7.69031C3.43028 7.67053 3.45628 7.66063 3.47331 7.63689L7.81649 1.53617C8.10989 1.12336 8.04446 0.526173 7.67037 0.202444V0.202443Z" fill="white"/>
</svg>
`;
...
var require$$0 = /*@__PURE__*/getAugmentedNamespace(icons$1);
...
function requireDist () {
	...
	hasRequiredDist = 1;
	const { checkboxCheck, checkboxIndeterminate, checked, } = require$$0;
	dist = { checkboxCheck, checkboxIndeterminate, checked, };
	return dist;
}
...
const icons = {
    'checkbox-check': distExports.checkboxCheck,
    checkboxCheck: distExports.checkboxCheck,
    'checkbox-indeterminate': distExports.checkboxIndeterminate,
    checkboxIndeterminate: distExports.checkboxIndeterminate,
...
const iconCss = () => `:host{--icon-color:currentcolor;--icon-size:100%;display:inline-flex;align-items:center;justify-content:center;line-height:0;vertical-align:middle}:host svg{display:block;fill:var(--icon-color);width:var(--icon-size);height:var(--icon-size)}:host svg *{fill:inherit}`;
...
class OrchestraIcon {
    ...
    render() {
        return hAsync(Host, { key: 'ee0457d5d7dae502d98bb46f9b7fa6e50e8b62f0' });
    }
    /**
