import{r as n}from"./iframe-CVgUuX1Z.js";const o=["checked"],l={component:"orchestra-icon",title:"Components/orchestra-icon",argTypes:{name:{type:{name:"string",required:!0},control:{type:"select"},options:o,description:"Icon name from the registered library"},fill:{control:{type:"text"},description:"SVG fill color"},size:{control:{type:"text"},description:"Icon size (CSS unit)"}},args:{name:o[0],fill:"currentcolor",size:"60px"}},r={render:e=>`<orchestra-icon name="${e.name}" library="core" fill="${e.fill}" size="${e.size}"></orchestra-icon>`,args:{name:"checked",fill:"currentcolor",size:"60px"}},t={render:e=>`<orchestra-icon name="${e.name}" library="custom" fill="${e.fill}" size="${e.size}"></orchestra-icon>`,args:{name:"star",fill:"currentcolor",size:"60px"},decorators:[e=>{const s={star:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" fill="currentColor"/></svg>',heart:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" fill="currentColor"/></svg>'};return n("custom",{resolver:i=>s[i]??""}),e()}],argTypes:{name:{control:{type:"text"},description:"Icon name from the custom library (string input)"}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
...
} satisfies Story`,...t.parameters?.docs?.source}}};const c=["Default","CustomLibrary"],m=Object.freeze(Object.defineProperty({__proto__:null,CustomLibrary:t,Default:r,__namedExportsOrder:c,default:l},Symbol.toStringTag,{value:"Module"}));export{t as C,r as D,m as I};
