...
export const parameters = {
  ...
  docs: {
    components: {
      ...
      p: ({children}) => <Text className="ff-openSans">{children}</Text>,
      b: ({children}) => <Text as="b" className="ff-openSans fw-bold">{children}</Text>,
      strong: ({children}) => <Text as="strong" className="ff-openSans fw-bold">{children}</Text>,
